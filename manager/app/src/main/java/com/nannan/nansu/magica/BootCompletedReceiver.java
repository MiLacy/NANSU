package com.nannan.nansu.magica;

import static com.nannan.nansu.magica.AppZygotePreload.TAG;
...
import com.nannan.nansu.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.nannan.nansu.magica.LAUNCH".equals(action)) {
            return;
        }
