...
Before reporting a bug, please first read the [document](https://kernelsu.org)
...
When you [Open an issue](https://github.com/Guxin12/NANSU/issues), you **must**:
...
[Open an issue](https://github.com/Guxin12/NANSU/issues) describing the feature you want and your reason for it.
...
```
>- then Joe Smith would upload the patch for NanSU as
```
