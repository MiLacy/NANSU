...
一个 Android 上基于内核的 root 方案，由 [`tiann/KernelSU`](https://github.com/tiann/KernelSU) 分叉而来，添加了一些功能。
...
>  4. 需要使用ShirkNeko的[KernelPatch开源仓库](https://github.com/ShirkNeko/SukiSU_KernelPatch_patch
)修补构建产物Image。
...
- [ShirkNeko](https://github.com/ShirkNeko): 提供KPM支持。
